...
> = {
  ...
  PARTIALLY_APPROVED: { label: 'Teilweise freigegeben', tone: 'success' },
...
export const AUDIT_LABELS: Record<string, string> = {
  ...
  CASE_ITEM_DECIDED: 'Kunde hat eine Position entschieden',
  CASE_ATTACHMENT_ADDED: 'Foto hinzugefügt',
