...
| **Block 4** | **Delivery & Portal-Ausbau** — realer E-Mail/SMS-Provider, automatische Reminder-Policy, Foto-Uploads produktiv, mehrere Positionen mit Einzelauswahl | geplant |
| **Block 5** | **API Hardening / Integration Readiness** — echte Auth (JWT + API-Keys/Scopes), Rate-Limiting, echte Webhook-Zustellung (HMAC/Retry), Idempotency persistent | geplant |
